...
5. Run `scripts/build_copy.py` to render clean written `copy.md`, internal `copy-blueprint.md`, and `sales-page-blueprint.json`. Do not hand-author `copy.md` as the source of truth in deep mode.
...
8. `copy-blueprint.md` must include these exact headings:
   ...
   - `# Final CTA`
9. `copy.md` must be clean written long-form sales copy only. It must not contain `# Section Blueprint`, schema notes, or section tables; those belong in `copy-blueprint.md`. It must contain 2,500+ customer-facing words; the target range is 3,500-5,500.
