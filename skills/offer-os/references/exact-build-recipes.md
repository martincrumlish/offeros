...
5. Run `scripts/build_copy.py` to render exact page-copy `copy.md`, internal `copy-blueprint.md`, and `sales-page-blueprint.json`. Do not hand-author `copy.md` as the source of truth in deep mode.
   ...
   - The sales page builder must render the text inside those blocks exactly. It may add layout, images, icons, and CTAs from `[cta]...[/cta]`, but it must not summarize, rewrite, delete, compress, slice to three cards, or invent replacement copy.
