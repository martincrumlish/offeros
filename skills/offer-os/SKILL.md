...
- Studio commands: use `scripts/offeros.py` or the underlying studio builders: `build_visual_asset_plan.py`, `build_sales_page_studio.py`, `build_sales_page.py` compatibility wrapper, `build_email_sequence.py`, `build_workbook.py`, `build_vsl_deck.js`, `generate_delivery_dashboard.py`, and `validate_offer_outputs.py`.
...
11. Sales page build through `scripts/build_sales_page_studio.py`
...
- `scripts/build_sales_page_studio.py`: generate `index.html` from `sales-page-blueprint.json`, `theme.json`, controlled AC-inspired direct-response components, and manifest data.
- `scripts/build_sales_page.py`: compatibility wrapper for the Sales Page Studio builder.
