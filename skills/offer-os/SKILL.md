...
- When the user asks for generated images or a generated design direction with visual assets, use the `imagegen` skill/tool for bitmap hero/product/ad imagery unless blocked. Do not create or register SVG files for generated visual assets, logos, diagrams, ads, page art, PDF art, or VSL art. Use PNG/WebP/JPG bitmaps. HTML/CSS, Pillow, canvas, screenshots, or generated-by-code PNGs may support real diagrams/previews only; they cannot satisfy primary conversion visuals such as the product bundle, offer-stack bundle, product mockup, hero/VSL thumbnail, buyer-situation photo, or ad creatives.
