...
9. `visual-asset-plan.md` v2 anchored to copy sections, PDF page archetypes, VSL slide plan, and ad angles
10. coded sales page generated by the OfferOS Page Kit builder
11. supporting images
12. customer-ready PDF product
...
8. `sales-page-blueprint.json` and `theme.json`
9. Artifact-specific `visual-asset-plan.md` v2 anchored to the copy blueprint, PDF page archetypes, VSL slide plan, and ad angles
10. Sales-page graphics with provenance recorded
11. Sales page build through `scripts/build_sales_page.py`
12. PDF-specific visuals and PDF product creation/rendered visual check
13. Ads and ad-specific imagegen images
14. Email sequence
15. VSL-specific visuals and VSL deck
16. Delivery dashboard
