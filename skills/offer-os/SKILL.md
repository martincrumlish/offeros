...
- When the user asks for generated images or a generated design direction with visual assets, use the `imagegen` skill/tool for bitmap hero/product/ad imagery unless blocked. Do not create or register SVG files for generated visual assets, logos, diagrams, ads, page art, PDF art, or VSL art. Use PNG/WebP/JPG bitmaps, HTML/CSS blocks, or rendered PNG diagrams instead.
