...
OfferOS is a Codex plugin for building complete commercial offer systems: offer architecture, design direction, professional no-SVG imagegen-based logo lockups/images, copy-blueprint-driven visual plans, direct-response long-form sales pages, imagegen visual worker dispatch, long-form sales copy, coded sales page, PDF product, ads, launch emails, VSL deck, delivery dashboard, and QA.
...
```text
Install the OfferOS skill from https://github.com/martincrumlish/offeros/tree/v0.10.1/skills/offer-os
```
...
git -C "$HOME\plugins\offer-os" checkout v0.10.1
```
...
git status
git add .
git commit -m "Release OfferOS v0.10.1"
git tag v0.10.1
