...
```text
Install the OfferOS skill from https://github.com/martincrumlish/offeros/tree/v0.10.3/skills/offer-os
```
...
git -C "$HOME\plugins\offer-os" checkout v0.10.3
```
...
git status
git add .
git commit -m "Release OfferOS v0.10.3"
git tag v0.10.3
